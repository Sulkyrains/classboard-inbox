...
declare global{interface Window{AndroidApp?:{notify?:(id:string,title:string,body:string)=>void;version?:()=>string;theme?:(mode:'dark'|'light')=>void;checkUpdate?:()=>void;notifyStatus?:()=>string;checkNow?:()=>void;testNotification?:()=>void;setKeepAlive?:(on:boolean)=>void;openBatterySettings?:()=>void;openAutoStart?:()=>void};}}
