...
export function guideFor(kind:EnvKind){
  ...
  if(kind==='ios')return <div className="install-guide" role="status"><p>iPhone 收推送需先添加到主屏幕：</p><ol><li>用 <strong>Safari</strong> 打开本站</li><li>点底部中间的<strong>分享</strong>按钮（方框加箭头图标）</li><li>下滑点「<strong>添加到主屏幕</strong>」→「添加」</li><li>从桌面打开「知可而办」，在「个人账号」中开启推送</li></ol></div>;
